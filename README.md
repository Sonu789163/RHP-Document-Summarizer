...
# N8N Webhook URLs
# Chat Webhooks
VITE_N8N_CHAT_DRHP_WEBHOOK_URL=https://n8n-excollo.azurewebsites.net/webhook/1/chat/docs
VITE_N8N_CHAT_RHP_WEBHOOK_URL=https://n8n-excollo.azurewebsites.net/webhook/1/chat/docs

# Summary Webhooks
VITE_N8N_SUMMARY_DRHP_WEBHOOK_URL=http://localhost:5678/webhook/test-3/summary
VITE_N8N_SUMMARY_RHP_WEBHOOK_URL=https://n8n-excollo.azurewebsites.net/webhook/test-1/rhp/summary

# Report Webhook
VITE_N8N_REPORT_WEBHOOK_URL=https://n8n-excollo.azurewebsites.net/webhook/compare-rhp-drhp

# Upload Webhook
VITE_N8N_WEBHOOK_URL=https://n8n-excollo.azurewebsites.net/webhook/bfda1ff3-99be-4f6e-995f-7728ca5b2f6a
```
